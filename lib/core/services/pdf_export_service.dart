...
Future<Uint8List> _buildSalaryPdfBytes(_SalaryPdfParams p) async {
  ...
  pdf.addPage(pw.Page(
    ...
    build: (ctx) => PdfExportService._buildSummaryPage(
      ctx: ctx,
...
Future<Uint8List> _buildBonusPdfBytes(_BonusPdfParams p) async {
  ...
  pdf.addPage(pw.Page(
    pageFormat: PdfPageFormat.a4,
    margin: const pw.EdgeInsets.fromLTRB(36, 36, 36, 28),
    build: (ctx) => PdfExportService._buildBonusPage(
      ctx: ctx,
      grossAnnual: p.grossAnnual,
...
Future<Uint8List> _buildTaxBreakdownPdfBytes(_TaxBreakdownPdfParams p) async {
  ...
  pdf.addPage(pw.Page(
    pageFormat: PdfPageFormat.a4,
    margin: const pw.EdgeInsets.fromLTRB(36, 36, 36, 28),
    build: (ctx) => PdfExportService._buildTaxBreakdownPage(
      ctx: ctx,
      grossAnnual: p.grossAnnual,
      brackets: brackets,
      fr: p.fr,
...
Future<Uint8List> _buildRaisePdfBytes(_RaisePdfParams p) async {
  ...
  pdf.addPage(pw.Page(
    pageFormat: PdfPageFormat.a4,
    margin: const pw.EdgeInsets.fromLTRB(36, 36, 36, 28),
    build: (ctx) => PdfExportService._buildRaisePage(
      ctx: ctx,
...
Future<Uint8List> _buildRetirementPdfBytes(_RetirementPdfParams p) async {
  ...
  pdf.addPage(pw.Page(
    pageFormat: PdfPageFormat.a4,
    margin: const pw.EdgeInsets.fromLTRB(36, 36, 36, 28),
    build: (ctx) => PdfExportService._buildRetirementPage(
      ctx: ctx,
...
Future<Uint8List> _buildRrspPdfBytes(_RrspPdfParams p) async {
  ...
  pdf.addPage(pw.Page(
    pageFormat: PdfPageFormat.a4,
    margin: const pw.EdgeInsets.fromLTRB(36, 36, 36, 28),
    build: (ctx) => PdfExportService._buildRrspPage(
      ctx: ctx,
      grossIncome: p.grossIncome,
      rrspRoom: p.rrspRoom,
      contribution: p.contribution,
...
Future<Uint8List> _buildSalaryComparisonPdfBytes(
  ...
  pdf.addPage(pw.Page(
    pageFormat: PdfPageFormat.a4,
    margin: const pw.EdgeInsets.fromLTRB(36, 36, 36, 28),
    build: (ctx) => PdfExportService._buildSalaryComparisonPage(
      ctx: ctx,
      grossA: p.grossA,
      grossB: p.grossB,
  ...
  static pw.Widget _buildSummaryPage({
    ...
    return pw.Column(
      ...
      children: [
        ...
        pw.Spacer(),
        PdfBrandHelper.footer(ctx, 'Salary Calculator'),
      ],
    );
  }
