...
class PdfExportService {
  ...
  static Future<void> exportSalary({
    ...
    await Printing.sharePdf(
      ...
      filename: 'SalaryCalc_${grossAnnual.round()}_${DateTime.now().millisecondsSinceEpoch}.pdf',
    );
  }
        ...
        pw.Row(
          ...
          children: [
            pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
              ...
              pw.Text('Take-Home Pay Report · ${state.toUpperCase()}, ${country.toUpperCase()}',
        ...
        pw.Row(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
          pw.Expanded(child: pw.Column(children: [
            _sectionBox('GROSS INCOME', [
              _row2('Annual Gross',      _cur0.format(grossAnnual), bold: true, color: _navy),
            ...
            _sectionBox('DEDUCTIONS', [
              ...
              _row2('Total Deductions',     _cur0.format(totalDeductions), bold: true),
            ]),
          ])),
          pw.SizedBox(width: 14),
          pw.Expanded(child: pw.Column(children: [
            _sectionBox('TAKE-HOME PAY', [
              _row2('Annual Net',    _cur0.format(netAnnual),    bold: true, color: _green),
              _row2('Monthly Net',   _cur0.format(netMonthly),   bold: true, color: _navy),
  ...
  static pw.Widget _footerNote() => pw.Column(children: [
    ...
    pw.Text('Generated by Salary Calculator · For illustration purposes only. Not financial advice.',
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Icon(Icons.picture_as_pdf_outlined, size: 36, color: AppTheme.primary),
            ...
            child: Container(
              ...
              child: Row(children: [
                Container(width: 44, height: 44,
                    ...
                    child: Icon(Icons.play_circle_outline, color: AppTheme.primary, size: 24)),
