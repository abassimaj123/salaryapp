...
class AppThemeUS {
  ...
  static ThemeData get lightTheme => ThemeData(
    ...
    extensions: [CalcwiseTheme.light(primary: Color(0xFFDC2626), accent: Color(0xFFF59E0B), primaryDeep: Color(0xFFB91C1C))],
    fontFamily: 'Inter',
  );
  ...
  static ThemeData get darkTheme => ThemeData(
    ...
    extensions: [CalcwiseTheme.dark(primary: Color(0xFFDC2626), accent: Color(0xFFF59E0B), primaryDeep: Color(0xFFB91C1C))],
    fontFamily: 'Inter',
  );
}
