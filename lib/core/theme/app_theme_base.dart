...
class AppThemeBase {
  ...
  // Common card theme
  static CardThemeData cardTheme({required Color backgroundColor}) => CardThemeData(
    elevation: 0,
  ...
  static InputDecorationTheme inputDecorationTheme({required Color primaryColor}) => 
