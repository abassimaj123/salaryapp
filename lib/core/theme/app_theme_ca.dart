...
class AppThemeCA {
  static const Color primaryLight   = Color(0xFFE67E22); // Burnt Orange (improved contrast)
  static const Color primaryDark    = Color(0xFFC86D1F); // Deep Burnt Orange
  static const Color secondaryLight = Color(0xFFEF4444); // Red for icons/accents
  ...
  static ThemeData get lightTheme => ThemeData(
    ...
    extensions: [CalcwiseTheme.light(primary: Color(0xFFE67E22), accent: Color(0xFFEF4444), primaryDeep: Color(0xFFC86D1F))],
    fontFamily: 'Inter',
  );
  ...
  static ThemeData get darkTheme => ThemeData(
    ...
    extensions: [CalcwiseTheme.dark(primary: Color(0xFFE67E22), accent: Color(0xFFEF4444), primaryDeep: Color(0xFFC86D1F))],
    fontFamily: 'Inter',
  );
}
